        ...
        <table style="width: 100%; border-collapse: collapse; margin-bottom: 2rem;">
          ...
          <tbody>
            <tr style="border-bottom: 1px solid #f0f0f0;">
              ...
              <td style="padding: 0.75rem 1rem; color: #4a4a4a;">Customization settings</td>
            </tr>
            <tr style="border-bottom: 1px solid #f0f0f0;">
              <td style="padding: 0.75rem 1rem;"><strong style="color: #1a1a1a;">Dividers</strong></td>
              <td style="padding: 0.75rem 1rem; color: #4a4a4a;">Separator lines</td>
            </tr>
            <tr style="border-bottom: 1px solid #f0f0f0;">
              <td style="padding: 0.75rem 1rem;"><strong style="color: #1a1a1a;">File Operations</strong></td>
              <td style="padding: 0.75rem 1rem; color: #4a4a4a;">File operations (upload, download, etc.)</td>
            </tr>
            <tr style="border-bottom: 1px solid #f0f0f0;">
              <td style="padding: 0.75rem 1rem;"><strong style="color: #1a1a1a;">System Info</strong></td>
              <td style="padding: 0.75rem 1rem; color: #4a4a4a;">System information display</td>
            </tr>
            <tr>
              <td style="padding: 0.75rem 1rem;"><strong style="color: #1a1a1a;">User Components</strong></td>
              <td style="padding: 0.75rem 1rem; color: #4a4a4a;">User-defined components</td>
            </tr>
          </tbody>
        </table>
      </div>
